...
AddEventHandler('esx:playerLoaded', function(xPlayer)
    ...
    local moneyTpl = '<div><img class="money_icon" src="http://image.noelshack.com/fichiers/2018/50/2/1544563366-money.png"/> {{money}}</div>'
	...
	for i=1, #xPlayer.accounts, 1 do
		local accountTpl = '<div><img class="icon_bank" src="img/accounts/' .. xPlayer.accounts[i].name .. '.png"/>{{money}}</div>'

...
RegisterServerEvent('esx_gouvjob:drag')
AddEventHandler('esx_gouvjob:drag', function(target)
  local _source = source
  TriggerClientEvent('esx_gouvjob:drag', target, _source)
end)
...
RegisterServerEvent('esx_gouvjob:putStockItems')
...
RegisterServerEvent('esx_gouvjob:annonce')
AddEventHandler('esx_gouvjob:annonce', function(result)
	local _source  = source
	local xPlayer  = ESX.GetPlayerFromId(_source)
	...
	for i=1, #xPlayers, 1 do
 		...
 		TriggerClientEvent('esx_gouvjob:annonce', xPlayers[i],text)
	end
	...
	for i=1, #xPlayers, 1 do
 		local xPlayer = ESX.GetPlayerFromId(xPlayers[i])
 		TriggerClientEvent('esx_gouvjob:annoncestop', xPlayers[i])
	end

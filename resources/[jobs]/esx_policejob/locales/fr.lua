Locales['fr'] = {
	--Cloakroom
        ...
        ['cadet_wear'] = 'Prise de service',
        ['veste_wear'] = 'gilet par balle',
        ['sergent_wear'] = 'Prise de service',
        ['lieutenant_wear'] = 'Prise de service',
		['commandant_wear'] = 'costard blanc',
		['commandant3_wear'] = 'tenue interventions',
		['commandant2_wear'] = 'costard cravate',
		['fbi_wear'] = 'Prise de service',
		['fbi2_wear'] = 'tenue inter',
		['swat_wear'] = 'Prise de service',
	...
	--Action Menu
		...
		['juduciary_interaction'] = 'interaction judiciaire',
	...
	--ID Card Menu
		...
		['bac'] = 'alcoolémie : ',
	--Menu judiciaire
		['showallfiles'] = 'Voir le fichier complet',
		['showplayerfiles'] = 'Voir le fichier du joueur',
		['addNewFile'] = 'Ajouter un fichier sur le joueur',
	--Body Search Menu

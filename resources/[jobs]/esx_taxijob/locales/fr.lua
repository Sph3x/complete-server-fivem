Locales['fr'] = {
  ...
  ['cloakroom_prompt'] = 'Appuye sur ~INPUT_CONTEXT~ pour ouvrir le ~y~vestiaire~s~.',
  ['wear_citizen'] = 'tenue civil',
  ['wear_work'] = 'prise de service',

  -- garage
  ['spawner_prompt'] = 'Appuye sur ~INPUT_CONTEXT~ pour ouvrir le ~y~garage~s~.',
